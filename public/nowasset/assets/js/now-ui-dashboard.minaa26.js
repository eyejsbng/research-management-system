...
seq = 0, delays = 80, durations = 500, seq2 = 0, delays2 = 80, durations2 = 500,
    function () {
        ...
        //     new PerfectScrollbar(".sidebar-wrapper"), new PerfectScrollbar(".main-wrapper");
        ...
        0 != $(".tagsinput").length && $(".tagsinput").tagsinput(), $(".bootstrap-tagsinput").addClass(a + "-badge"), 0 != $(".selectpicker").length && $(".selectpicker").selectpicker({
            ...
            tickIcon: "ui-1_check"
        }), $("body").hasClass("sidebar-mini") && (sidebar_mini_active = !0), navigator.platform.startsWith("Win") && $(".modal").on("show.bs.modal", function () {
