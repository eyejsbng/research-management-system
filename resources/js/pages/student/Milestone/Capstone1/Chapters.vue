<template>
    <div>
        <div class="row">
            ...
            <div class="col-md-8 mr-auto ml-auto" v-if="groupinfo && groupinfo.info.caps1 == 0">
                <h4 class="text-center">Chapter 1-3 Submission</h4>
                <div class="card">
                    <div class="card-body">
                        <div class="alert alert-warning text-center">
                            <span v-if="isUpdate == false" >Submit Chapter 1 to 3 to your Adviser. <br> Submit only Docs file.</span>
                        ...
                        <div class="row" v-if="groupinfo">
                            <div class="col-md-8 mr-auto ml-auto" v-if="groupinfo.adviser.id != 2">
                                <button v-if="isUpdate == false" @click="SubmitDocs" class="btn btn-info btn-round btn-block"
                                    :disabled="loading == true">
                                    <span v-if="loading == true" class="spinner-grow spinner-grow-sm" role="status"
                                        aria-hidden="true"></span>
                                    Send
                                </button>
                                <button v-if="isUpdate == true" @click="Update" class="btn btn-info btn-round btn-block"
                                    :disabled="loading == true">
                                    <span v-if="loading == true" class="spinner-grow spinner-grow-sm" role="status"
                                        aria-hidden="true"></span>
                                    Update
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hovered">
                                ...
                                <tbody>
                                    <tr v-for="(docs,index) in getcaps1submitteddocs.documents1" :key="docs.dcs_id">
