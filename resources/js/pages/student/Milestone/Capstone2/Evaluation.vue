<template>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-warning text-center" v-if="grp.caps2 == 2">
                <span>
        ...
        <div class="col-md-12 mr-auto ml-auto" v-for="e in getcaps1evalution.eval2" :key="e.dt_id">
    ...
    export default {
        ...
        methods:{
            ...
            Sendfile() {
                ...
                formdata.append('chapter', 'Chapter1to3' )
