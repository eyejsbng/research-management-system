<template>
    <div v-if="getcaps1evalution.eval2 && getcaps1revisefile.revise2">
        <div class="row" v-if="getcaps1evalution.eval2[0].dt_status != 4 && grp.caps1 != 0">
            <div class="col-md-12">
                <h4 class="title text-center">Chapter 1 to 6 Document Checking</h4>
                <p class="text-center">Thesis/Capstone 2</p>
                <div class="row">
                    <div class="col-md-6 mr-auto ml-auto">
                        <div class="alert alert-warning text-center">
                            ...
                            <span v-if="getcaps1revisefile.revise2.length == 0">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12" v-if="getcaps1revisefile.revise2.length > 0">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hovered">
                                                ...
                                                <tbody>
                                                    <tr v-for="(revise,index) in getcaps1revisefile.revise2" :key="revise.rev_id">
                                ...
                                <div class="row" v-if="getcaps1evalution.eval2[0].dt_status == 1 || showrevise == true && revise.rev_panID == user.id" >
                                    <div class="col-md-12">
        ...
        <div class="row" v-if="getcaps1evalution.eval2[0].dt_status == 4">
            <div class="col-md-12">
                <h4 class="title text-center">Evaluation Form</h4>
                <p class="text-center">Thesis/Capstone 2</p>
                <div class="card">
                    <div class="card-header">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="text-center">
                            <tr>
                                ...
                                <td>
                                    <input @keyup="SetScore(1)" v-model="getcaps1evalution.eval2[0].dt_sintro" type="number"
                                ...
                                <td>
                                    {{ getcaps1evalution.eval2[0].dt_pintro }}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input @keyup="SetScore(2)" v-model="getcaps1evalution.eval2[0].dt_srelated" type="number"
                                        class="form-control text-center" placeholder="1-100">
                                </td>
                                <td>
                                    10%
                                ...
                                <td>
                                    {{ getcaps1evalution.eval2[0].dt_prelated }}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input @keyup="SetScore(4)" v-model="getcaps1evalution.eval2[0].dt_sgeneral" type="number"
                                        class="form-control text-center" placeholder="1-100">
                                </td>
                                <td>
                                    15%
                                ...
                                <td>
                                    {{ getcaps1evalution.eval2[0].dt_pgeneral }}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input @keyup="SetScore(5)" v-model="getcaps1evalution.eval2[0].dt_soral" type="number"
                                        class="form-control text-center" placeholder="1-100">
                                </td>
                                <td>
                                    20%
                                ...
                                <td>
                                    {{ getcaps1evalution.eval2[0].dt_poral }}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input @keyup="SetScore(3)" v-model="getcaps1evalution.eval2[0].dt_ssystem" type="number"
                                        class="form-control text-center" placeholder="1-100">
                                </td>
                                <td>
                                    30%
                                ...
                                <td>
                                    {{ getcaps1evalution.eval2[0].dt_psystem }}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    {{ getcaps1evalution.eval2[0].dt_stotal }}
                                </td>
                                <td>
                                    100%
                                </td>
                                <td>
                                    {{ getcaps1evalution.eval2[0].dt_ptotal }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea v-model="getcaps1evalution.eval2[0].dt_comments" class="form-control"></textarea>
                </div>
            </div>
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input v-model="getcaps1evalution.eval2[0].dt_recommendation" true-value="1" type="checkbox"
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input v-model="getcaps1evalution.eval2[0].dt_recommendation" true-value="2" type="checkbox"
                                    class="form-check-input">
                                <span class="form-check-sign"></span>
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input v-model="getcaps1evalution.eval2[0].dt_recommendation" true-value="3" type="checkbox"
                                    class="form-check-input">
                                <span class="form-check-sign"></span>
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input v-model="getcaps1evalution.eval2[0].dt_recommendation" true-value="4" type="checkbox"
                                    class="form-check-input">
                                <span class="form-check-sign"></span>
                                Rejected
                            </label>
            ...
            <div class="col-md-6 mr-auto ml-auto mt-5">
                <button @click="Evaluate" v-if="grp.caps2 == 2" class="btn btn-info btn-round btn-block">
                    <i class="fas fa-check"></i>
                    Evaluate
                </button>
                <p v-if="grp.caps2 < 2" class="text-center text-primary" style="font-size:12px;">
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                if (status == 3) {
                    ...
                    axios.post('../api/decissionsubmission', {
                        ...
                        if (res.data.message == 'success') {
                            ...
                            this.getcaps1evalution.eval2[0].dt_status = 4
            ...
            UpdateModal(index){
                this.revise = this.getcaps1revisefile.revise2[index]
            ...
            Clear(){
                ...
                this.loading = false
                this.showrevise = false
                this.getcaps1evalution.eval2[0].dt_status = 3
            ...
            SetScore(s) {
                if (s == 1) {
                    this.getcaps1evalution.eval2[0].dt_pintro = Number(this.getcaps1evalution.eval2[0].dt_sintro * .25);
                    this.SetTotal()
                } else if (s == 2) {
                    this.getcaps1evalution.eval2[0].dt_prelated = Number(this.getcaps1evalution.eval2[0].dt_srelated * .10);
                    this.SetTotal()
                } else if (s == 3) {
                    this.getcaps1evalution.eval2[0].dt_psystem = Number(this.getcaps1evalution.eval2[0].dt_ssystem *
                        .30);
                    this.SetTotal()
                } else if (s == 4) {
                    this.getcaps1evalution.eval2[0].dt_pgeneral = Number(this.getcaps1evalution.eval2[0].dt_sgeneral * .15);
                    this.SetTotal()
                } else if (s == 5) {
                    this.getcaps1evalution.eval2[0].dt_poral = Number(this.getcaps1evalution.eval2[0].dt_soral * .20);
                    this.SetTotal()
                }
            },
            SetTotal() {
                this.getcaps1evalution.eval2[0].dt_stotal = Number(this.getcaps1evalution.eval2[0].dt_sintro) + Number(this
                        .getcaps1evalution.eval2[0].dt_srelated) +
                    Number(this.getcaps1evalution.eval2[0].dt_ssystem) + Number(this.getcaps1evalution.eval2[0].dt_sgeneral) +
                    Number(this.getcaps1evalution.eval2[0].dt_soral)
                this.getcaps1evalution.eval2[0].dt_ptotal = Number(this.getcaps1evalution.eval2[0].dt_pintro) + Number(this
                        .getcaps1evalution.eval2[0].dt_prelated) +
                    Number(this.getcaps1evalution.eval2[0].dt_psystem) + Number(this.getcaps1evalution.eval2[0].dt_pgeneral) +
                    Number(this.getcaps1evalution.eval2[0].dt_poral)
            },
            Evaluate() {
                axios.post('../api/panelevaluation2', this.getcaps1evalution.eval2[0]).then(res => {
                    if (res.data.message == 'success') {
