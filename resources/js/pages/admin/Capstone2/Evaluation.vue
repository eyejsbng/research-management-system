<template>
    <div class="row">
        <div class="col-md-12">
            <h4 class="title text-center">Evaluation and Validation Report</h4>
        </div>
        <div class="col-md-12">
            <h4 class="btn btn-link btn-block btn-info text-center" data-toggle="collapse" data-target="#title">Evaluation Form</h4>
        </div>
        <div class="col-md-12 mr-auto ml-auto collapse show" id="title" v-for="e in getcaps1evalution.eval2" :key="e.dt_id">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <p v-if="e.dt_recommendation == null">Noy yet check</p>
                        ...
                        <div class="col-md-4">
                            <p v-if="e.dt_date != null">{{ e.dt_date }}</p>
