<template>
    <div>
        <h4 class="title text-center">Turnitin 2</h4>
        <div class="row">
            <div class="col-md-8 mr-auto ml-auto">
                <div class="alert alert-warning text-center">
                    <span v-if="grp.caps2 == 3">
            ...
            <div class="col-md-8 mr-auto ml-auto" v-if="grp.caps2 == 3">
                <div class="card">
            ...
            <div class="col-md-6 mr-auto ml-auto">
                <h5 class="text-center">Approved Chapter 1 to 6</h5>
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hovered">
                                ...
                                <tbody class="text-center">
                                    <tr v-for="d in getcaps1checkdocs.document2" :key="d.dcs_id">
            ...
            <div class="col-md-6 mr-auto ml-auto">
                <h5 class="text-center">Grammarly 2 Report</h5>
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hovered">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hovered">
                                ...
                                <tbody class="text-center">
                                    <tr v-for="e in getcaps1evalution.eval2" :key="e.dt_id">
                                        <td>{{ e.name }}</td>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hovered">
                                ...
                                <tbody class="text-center">
                                   <tr v-for="g in getcaps1grammarly.plagiarism2" :key="g.pla_id">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hovered">
                                ...
                                <tbody class="text-center">
                                    <tr v-for="val in getcaps1validation.valid2" :key="val.val_id">
                                        <td>{{ val.name }}</td>
                                        <td>{{ val.val_total }}</td>
                                    </tr>
                                </tbody>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            DocumentDL(str) {
                this.path = '../app/myfiles/Submittedfiles/Capstone2/' + str
            },
            PlagiarismDL(str){
            ...
            UploadPlagiarism(){
                ...
                formdata.append('document', 'Plagiarism 2')
